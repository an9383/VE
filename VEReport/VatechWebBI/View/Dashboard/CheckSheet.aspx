<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckSheet.aspx.cs" Inherits="View_Dashboard_CheckSheet" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function onDashboardTitleToolbarUpdated(sender, args) {
            ...
            addItem(items, "customReportIcon1", OpenPop_SelReport, "체크시트 보기");
        ...
        var keyDataField = "";
        var keyFieldName2 = "StepEntryTxnId";
        var keyDataField2 = "";
        var keyBrandName = "BrandName";
        var keyDataField3 = "";
        ...
        function OpenPop_SelReport() {
            const arrKey = ['ContainerId', 'StepEntryTxnId', 'BrandName'];
            ...
            var url = "../Report/TACheckSheet.aspx?reportid=" + urlParam;
